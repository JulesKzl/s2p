...
=======
>>>>>>> 1017f757d9d3789a9f65e90c6724c6722ef2159e


\section{Satellite imagery}
\subsection{Localization and projection functions}
We define here the localization and projection functions  allow converting from image coordinates to coordinates
...
<<<<<<< HEAD
 We first try our modified pipeline with improved pointing error correction on Pléiades images (see Figure \ref{fig:testdata}) from the \verb|s2p| Github repositroy. These images are located on the island of Reunion. We can see on Figure \ref{fig:testdata-location} that the errors of the RPC function of the two images.\\

=======
 We first try our modified pipeline with improved pointing error correction on Pléiades images (see Figure \ref{fig:testdata}) from the \verb|s2p| Github repositroy. These images are located on the island of Reunion. We can observe on Figure \ref{fig:testdata-location} the error of the RPC function of the two images.\\
 
>>>>>>> 46a263afec76b31ba245313efead5990c5aefb39
            \begin{figure}[H]
            \centering
        ...
        \begin{figure}[H]
    \centering
    \includegraphics[width = 0.7\textwidth]{figures/geoloc_testdata.png}
    \caption{Geolocation of Pléiades images (Réunion).}
    \label{fig:testdata-location}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.7\textwidth]{figures/geoloc_video.png}
    \caption{Geolocation of the SkySat video (Australia). }
    \label{fig:video-location}
\end{figure}
...
=======
          ...
          \begin{figure}[H]
    \centering
    \includegraphics[width = 0.7\textwidth]{figures/8Z_trace.jpeg}
    \caption{Trace at a given time from the $3$ cameras of a SkySat satellite.}
    \label{fig:8Z_trace}
\end{figure}
